...
import com.example.learningmachineparentsapp.Utils.DensityUtils;
...
public class PopupWindowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_popup_window, parent, false);
